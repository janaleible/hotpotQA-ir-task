...
L2R_TRAINING_SET = os.path.join(L2R_DIR, 'training_set_full.tar')
L2R_TEST_SET = os.path.join(L2R_DIR, 'test_set_full.tar')
# L2R_TRAINING_SET = os.path.join(L2R_DIR, 'training_set_dummy.tar')
# L2R_TEST_SET = os.path.join(L2R_DIR, 'test_set_dummy.tar')
L2R_MODEL = os.path.join(L2R_DIR, 'model.pt')
L2R_INTERMEDIATE_MODEL = os.path.join(L2R_DIR, 'model_{}.pt')
L2R_STATE_DICT = os.path.join(L2R_DIR, 'model_state_dict.pt')
L2R_TMP_TRAIN_PROGRESS = os.path.join(L2R_DIR, 'tmp_learning_progress.csv')
L2R_LEARNING_PROGRESS_PLOT = os.path.join(L2R_DIR, 'learning_progess.png')
