...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--sub_action', type=bool, default=False,
                        help='Parameter control for actions.', choices=['E6B.50', 'E6B.100', 'E6B.200', 'E6B.300'])
